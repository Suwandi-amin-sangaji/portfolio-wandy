        ...
        development."
          >
            ...
            <section className="profesional flex items-center gap-7 px-3 mb-3 md:mb-5">
              <List textname="Fullstack  Developer/Software Engineer" />
              <List textname="Based In Sorong Papua Barat Daya 🇮🇩" />
            </section>
          </HeaderMain>
          <CareerMain />
          <Services />
...
export const metadata: Metadata = {
  title: "Discover the Work of Suwandi Amin Sangaji, Fullstack Developer",
  description:
