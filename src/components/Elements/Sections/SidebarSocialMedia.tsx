  ...
  return (
    <section className="flex flex-col items-center gap-4 border-t border-slate-600 dark:border-t-slate-200 border-dashed py-5 lg:grid lg:grid-cols-2">
      <ButtonWithImage
        useButton={false}
        blank="_blank"
        linkUrl="https://github.com/Suwandi-amin-sangaji"
      ...
      <ButtonWithImage
        useButton={false}
        blank="_blank"
        linkUrl="https://www.linkedin.com/in/suwandi-amin-sangaji-1762941b2/"
      ...
      <ButtonWithImage
        useButton={false}
        blank="_blank"
        linkUrl="https://instagram.com/suwandi-amin-sangaji/"
